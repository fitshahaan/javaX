 ...
 *
 */
public class LocationClusterDao extends BaseCollection
{
	DBCollection collection;

	public LocationClusterDao(DBCollection collection) {
		// TODO Auto-generated constructor stub
		this.collection=collection;
	}
	public LocationClusterDao() {
		// TODO Auto-generated constructor stub
	}
	...
	public DBObject getCluster(final String cluster) {
		 BasicDBObject regexQuery = new BasicDBObject();
		    regexQuery.put("name",new BasicDBObject("$regex", cluster).append("$options", "i"));
